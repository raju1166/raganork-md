...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://imgur.com/a/kayKDMJ.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '923310469548@g.us',
    ...
    BOT_INFO: process.env.BOT_INFO || 'Maira;Anjam;https://imgur.com/a/kayKDMJ.jpeg;https://chat.whatsapp.com/FonJZyhtpJeILctAU2c04X',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "Maira",
    BOT_NAME: process.env.BOT_NAME || 'Maira Anjam',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'Maira;Anjam;https://imgur.com/a/kayKDMJ.jpeg' : process.env.AUDIO_DATA,
    ...
    SUDO: process.env.SUDO || "923097045246",
